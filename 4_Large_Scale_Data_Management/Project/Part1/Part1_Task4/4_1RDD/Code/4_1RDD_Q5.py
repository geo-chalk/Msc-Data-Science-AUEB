...
# movies with positive year and revenue
...
#d efine function which for each year creates a tuple of the revenue and the 1 is for the count
def avg_map_func(row):
    return (int(row[0]), (int(row[1]), 1))

# gets a tuple and calculates the sum for each index. Similar to _ + _
